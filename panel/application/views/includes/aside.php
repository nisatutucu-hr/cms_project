            ...
            <div class="menubar-scroll-inner">
                <ul class="app-menu">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li><a href="<?php echo base_url() ?>/default/index.html"><span class="menu-text">Default</span></a></li>
                            <li><a href="<?php echo base_url() ?>/topbar/index.html"><span class="menu-text">Topbar</span></a></li>
                        </ul>
                    </li>
